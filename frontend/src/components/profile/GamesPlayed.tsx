...
const GamesPlayed = ({userId}: GameStatsInfo) => {
    ...
    return (
        <div className="bg-beige col-span-2 rounded border border-white shadow-md w-fulll h-full overflow-x-auto">
            <h1 className="text-black font-bold text-xl mb-2">Match History</h1>
