...
import { useFriendslist } from "../hooks/useFriendsList";import { Card } from "../components/utils/Card";
	...
	return (
        ...
        <div className="absolute top-5 right-10">
			...
			{tournamentToggle ? <Card image="/images/noTournament.webp"/> : 
				<Card image="/images/tournament.webp" link={"/play/tournament"} data={userInfo}/>}
			<Card image="/images/new_profile.webp" link={"/profile"} data={userInfo.userId}/>
